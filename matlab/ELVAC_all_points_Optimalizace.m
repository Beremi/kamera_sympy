...
for j=1:102
    ...
    x01= x+[1,1,1,0.00001,0.00001,0.00001]';%[25,25,50,20*pi/180,20*pi/180,20]'.*(2*rand(6,1)-1);%
    
    %[x,it]=fmin_sd(x01(1).*1e-3,x01(2).*1e-3,(x01(3)).*1e-3,x01(4),x01(5),x01(6),,f_presc,v,n,L,1e-4);
...
ylabel("Value of F (minsquare cost)")
title("Minimization results for all configurations")
